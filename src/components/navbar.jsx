...
export default function Navbar() {
  ...
  return (
    <div className="navbar flex gap-[40px] w-[1240px] justify-center items-center mx-auto mt-[10px] ">
      ...
      <div className="searchBar w-[577px]">
        <form
          action="/search"
          method="GET"
          className="flex grow shrink-0 basis-0 pt-[12px] pb-[12px] pr-[16px] pl-[16px] items-start gap-[12px] rounded-[62px] bg-[#F0F0F0]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
          ...
          <input
            ...
            className="text-[rgba(0,0,0,0.4)] font-[Satoshi] text-[16px] not-italic font-[400] leading-normal"
          />
        </form>
      </div>
