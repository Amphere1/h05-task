...
export default function Navbar() {
  ...
  return (
    <div className="navbar flex flex-wrap gap-4 lg:gap-[40px] w-full lg:w-[1240px] justify-between lg:justify-center items-center mx-auto mt-[10px] px-4 lg:px-0">
      <div className="flex items-center justify-between w-full lg:w-auto">
        <p className="text-[#000000] leading-tight font-[Integral CF] text-2xl lg:text-[32px] not-italic leading-normal">
          SHOP.CO
        </p>
        {/* Mobile menu button */}
      ...
      <div className={`${isMobileMenuOpen ? 'flex' : 'hidden'} lg:flex flex-col lg:flex-row w-full lg:w-auto gap-4 lg:gap-[24px]`}>
      ...
      <div className="searchBar w-full lg:w-[577px] order-first lg:order-none">
        <form
          action="/search"
          method="GET"
          className="flex items-center pt-[12px] pb-[12px] pr-[16px] pl-[16px] gap-[12px] rounded-[62px] bg-[#F0F0F0]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
          ...
          <input
            ...
            className="w-full text-[rgba(0,0,0,0.4)] font-[Satoshi] text-[16px] not-italic font-[400] leading-normal bg-transparent outline-none"
          />
        </form>
      </div>

      <div className="flex items-center gap-[14px] ml-auto lg:ml-0">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
